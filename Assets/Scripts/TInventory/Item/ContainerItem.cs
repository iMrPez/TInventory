...
namespace TInventory.Item
{
    public class ContainerItem : Item
    {
        ...
        public void Show()
        {
            ...
            {
                _window.AddContent(_container.RectTransform);
            }
        ...
        public override object GetModel()
        {
            ...
            var containerItemModel = new ContainerItemModel(itemModel, containerModel, _containerData);
        ...
        public override bool LoadModel(string modelJson)
        {
            ...
            _containerData = m.containerData;
    ...
    public struct ContainerItemModel
    {
        ...
        public ContainerItemModel(string itemModelJson, string containerModelJson, ContainerData containerData)
        {
